...
function numeroMaior (numero) {
    ...
    Elementochute.innerHTML += '<div>O número secreto é menor  <i class="fa-thin fa-arrow-down-long"></i></div>'
    return
}
function numeroMenor (numero) {
    if(numero>1 && numero<numeroAleatorio)
    Elementochute.innerHTML += '<div>O número secreto é maior <i class="fa-regular fa-arrow-up"></i> </div>'
    return 
}
